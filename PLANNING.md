...
## Goal
Maintain a clear execution roadmap for **dreidel-3d-sim** based on current codebase signals.

## Current Baseline
- Stack: Node.js, Vite, TypeScript
- Codebase scan size: 60 files (capped)
- Test signal: No obvious automated test structure detected
- CI workflows present: Yes
- GitHub Remote: igor-kan/dreidel-3d-sim
